                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('products.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="count" value="{{ $product->count }}" type="text" class="form-control" id="exampleInputName1" placeholder="Count">
                                        </div>
                                        <div class="form-group">
                                            <label>Image Upload</label>
                                            <input name="img" value="{{ $product->img }}" type="file" class="form-control-file">
                                            <img src="{{ asset('img/'.$product->img) }}" width=" 300px">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputCity1">Description</label>
                                            <input name="description" value="{{ $product->description }}" type="text" class="form-control" id="exampleInputCity1" placeholder="Description">
                                        </div>
